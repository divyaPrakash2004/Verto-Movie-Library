...
export const MovieGrid = ({
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          <AlertCircle className="h-8 w-8 text-pink-500 mx-auto mb-4" />
          <p className="text-pink-500 mb-2">Failed to load movies</p>
  ...
  if (movies.length === 0) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          <Film className="h-12 w-12 text-slate-400 mx-auto mb-4 opacity-50" />
